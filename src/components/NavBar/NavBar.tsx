  ...
  return (
    <nav className={styles.nav}>
      ...
      <ul className={styles.navList}>
        ...
        <li className={styles.navListItem}>
          <Link href="/skills" className={styles.navListLink}>
            Skills
          </Link>
        </li>
        <li className={styles.navListItem}>
          <Link href="/contact" className={styles.navListLink}>
            Contacts
          </Link>
        </li>
      </ul>
      <ul className={styles.navContacts}>
        ...
        <li className={styles.navContactsItem}>
          <a
            href="https://github.com/netimaaa"
        ...
        <li className={styles.navContactsItem}>
          <a
            href="https://discord.gg/GsSMF8rsNk"
            className={styles.navContactsLink}
          >
